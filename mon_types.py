...
MonType("Sinuous",
        nouns = ["rope", "string", "noodle", "spaghetti", "strand", "fibre"],
...
MonType("Chonky",
        ...
        adjectives = ["rotund", "expansive", "hungry", "chonky",
            "thicc", "hearty"],
...
MonType("Grammar",
        nouns = ["Syntax", "Sentence",
            "construction", "subject", "predicate", "relation"],
        adjectives = ["grammatical", "syntactic", "internally consistent",
...
MonType("Bush",
        ...
        hats = ["beanie"])
coach = MonType("Coach",
        nouns = ["training", "whistle", "practice", "efficiency", "whistle",
            "dream", "effort", "teamwork", "spirit", "mentality", "victory",
            "competition", "achievement", "excellence", "potential",
            "technique", "mastery", "growth", "belief", "preparation"],
        adjectives = ["inspired", "united", "emotional", "cooperative",
            "improving", "developing", "trained", "optimized", "prepared"],
        verbs = ["teach", "learn", "grow", "develop", "instruct", "guide",
            "empower", "unite", "encourage"],
        held_items = ["whistle", "stopwatch"],
        hats = ["baseball cap"])
types.remove(coach)
